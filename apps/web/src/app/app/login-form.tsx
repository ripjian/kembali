...
/* Phone → 6-digit code sign-in, shared by the demo /app/login and the
 * tenant-scoped /app/join/[slug] page. First verified phone creates the
 * card, so login doubles as registration. When tenantId is set (join), the
 * new customer is created under that merchant. */
