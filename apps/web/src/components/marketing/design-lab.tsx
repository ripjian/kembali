...
const PALETTES: Palette[] = [
  ...
  },
  {
    id: "vinyl",
    label: "Vinyl",
    note: "Music-app black with electric green earnings. Streaming energy.",
    swatches: ["#16181A", "#1DB954", "#F4F4F0"],
    vars: {
      "--pandan": "#16181A",
      "--pandan-deep": "#101214",
      "--pandan-night": "#0A0B0C",
  ...
  },
  {
    id: "marquee",
    label: "Marquee",
    note: "Cinema black with signal red earnings. The boldest single accent.",
    swatches: ["#1B1B1D", "#D3232E", "#F5F3EE"],
    vars: {
      "--pandan": "#1B1B1D",
      "--pandan-deep": "#141416",
      "--pandan-night": "#0D0D0F",
  ...
  },
  {
    id: "ledger",
    label: "Ledger",
    note: "Payments navy with periwinkle earnings and mint progress. Fintech trust.",
    swatches: ["#0A2540", "#7A78FF", "#F6F8FA"],
    vars: {
      "--pandan": "#0A2540",
      "--pandan-deep": "#071A2E",
      "--pandan-night": "#051221",
  ...
  },
  {
    id: "arcade",
    label: "Arcade",
    note: "Deep violet with bright purple earnings. Gaming-chat energy.",
    swatches: ["#2B2440", "#9B6DFF", "#F4F2F8"],
    vars: {
      "--pandan": "#2B2440",
      "--pandan-deep": "#201A31",
      "--pandan-night": "#151021",
  ...
  },
  {
    id: "flamingo",
    label: "Flamingo",
    note: "Dark berry with warm pink earnings on blush paper. Travel-app warmth.",
    swatches: ["#3B1F2B", "#FF5A7E", "#FBF4F2"],
    vars: {
      "--pandan": "#3B1F2B",
      "--pandan-deep": "#2B1520",
      "--pandan-night": "#1C0C14",
  ...
  },
  {
    id: "sprout",
    label: "Sprout",
    note: "Near-black with cartoon green earnings and sunny progress. Playful streaks.",
    swatches: ["#101613", "#58CC02", "#FAFAF2"],
    vars: {
      "--pandan": "#101613",
      "--pandan-deep": "#0B100D",
      "--pandan-night": "#070A08",
  ...
  },
  {
    id: "graphite",
    label: "Graphite",
    note: "Hardware grey with clear blue earnings. The most minimal option.",
    swatches: ["#1D1D1F", "#2997FF", "#F5F5F7"],
    vars: {
      "--pandan": "#1D1D1F",
      "--pandan-deep": "#151517",
      "--pandan-night": "#0E0E10",
  ...
  },
  {
    id: "robin",
    label: "Robin",
    note: "Jeweller teal: robin-egg earnings on deep pine, brass progress.",
    swatches: ["#10201F", "#0ABAB5", "#F3F6F5"],
    vars: {
      "--pandan": "#173432",
      "--pandan-deep": "#102523",
      "--pandan-night": "#0A1817",
  ...
  },
  {
    id: "diner",
    label: "Diner",
    note: "Fast-food red canvas with golden earnings. Loud, hungry, unmissable.",
    swatches: ["#B01E28", "#FFC72C", "#FCF6EA"],
    vars: {
      "--pandan": "#B01E28",
      "--pandan-deep": "#8A1620",
      "--pandan-night": "#5E0E15",
  ...
  },
  {
    id: "neondusk",
    label: "Neon dusk",
    note: "Violet night with hot magenta earnings and cyan progress. Social-feed glow.",
    swatches: ["#4A2C6D", "#FF4D8D", "#F9F2F7"],
    vars: {
      "--pandan": "#4A2C6D",
      "--pandan-deep": "#37204F",
      "--pandan-night": "#241531",
